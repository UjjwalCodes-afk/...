    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-700 to-purple-900 text-white px-4 text-center">
      ...
      >
        ...
        <p className="text-xl leading-relaxed mt-4">
          Shreeya, aap meri zindagi mein kitni khaas thi,<br />
          ...
          Apne aap ko sudharne ki koshish kar raha hoon, sirf aapki izzat aur izhaar ke liye nahi,<br />
          balki apne liye, ek behtar insaan banne ke liye.<br /><br />
