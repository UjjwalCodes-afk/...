  ...
  return (
    <section className="py-16 bg-black text-white text-center px-4">
      ...
      >
        ...
        Aap sirf meri zindagi mein aayi nahi the, aap ne mujhe zinda feel karna sikhaya.<br />
        aap woh the jo meri baaton ke peeche chhupi feelings samajh lete thi — bina kahe.<br /><br />
        Maine kabhi express nahi kiya, par har roz tujhe dekh kar lagta tha — yaar, kaise kisi mein itna pyaar ho sakta hai?<br />
